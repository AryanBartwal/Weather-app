...
import { getWeather, getUserLocation, autoLat, autoLong } from '../utils/weather';
...
function WeatherApp() {
  ...
  const handleSearch = async (cityName) => {
    try {
      ...
      const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=085590031a30567d9813303060a2063c`);
